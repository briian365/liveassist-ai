# LiveAssist AI: Multi-Agent Support Portal with Real-Time Intelligence
...
🔗 **GitHub Repo**: https://github.com/briian365/liveassist-ai
...
# Configure Algolia (copy and edit .env)
cp .env.example .env
